      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center space-y-10">
        ...
        <div className="w-full max-w-5xl mx-auto rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl border-2 border-slate-800/40 bg-slate-950 relative group transition-all duration-300 hover:shadow-slate-950/30">
          <img
            src={officeHeroImage}
            onError={(e) => {
              (e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=1600&auto=format&fit=crop&q=80';
            }}
            ...
            <div className="flex flex-col items-center justify-center gap-4 pt-1 w-full max-w-full px-2">
              ...
              <div className="w-full max-w-6xl mx-auto mt-6 rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl border-2 border-slate-800/60 bg-slate-950 relative group transition-all duration-300 hover:shadow-slate-950/40">
                <img
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=1600&auto=format&fit=crop&q=80';
                  }}
