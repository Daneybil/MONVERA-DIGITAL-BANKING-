      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200/90 h-16 sm:h-20 px-4 sm:px-8 flex items-center justify-between shadow-2xs">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3.5">
            ...
            {/* User Profile & Account Menu Popover */}
            <div className="relative">
              ...
              >
                <div className="w-6 h-6 rounded-lg bg-slate-900 text-emerald-400 flex items-center justify-center font-black text-[11px]">
                  {currentUser.firstName?.[0] || 'U'}
                </div>
                <span className="hidden sm:inline">
                  Active: <strong className="font-extrabold">{currentUser.firstName} {currentUser.lastName}</strong>
                </span>
                <span className="sm:hidden font-bold">{currentUser.firstName}</span>
                <ChevronDown className={`w-3.5 h-3.5 text-slate-500 transition-transform ${personaMenuOpen ? 'rotate-180' : ''}`} />
              </button>

              {personaMenuOpen && (
                <div
                  id="header-user-dropdown"
                  className="absolute right-0 mt-2 w-72 bg-white rounded-2xl shadow-2xl border border-slate-200 py-3 z-50 animate-in fade-in slide-in-from-top-2"
                >
                  {/* Account Summary Header */}
                  <div className="px-4 pb-3 border-b border-slate-100">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-xl bg-slate-950 text-emerald-400 font-black text-sm flex items-center justify-center shadow-xs">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="text-[11px] text-slate-500 font-mono font-medium truncate">
                          Acc: {currentUser.permanentAccountNumber}
                        </div>
                      </div>
                    </div>

                    <div className="mt-2.5 flex items-center justify-between">
                      <span className="inline-flex items-center gap-1 text-[10px] font-black uppercase tracking-wider px-2 py-0.5 rounded-md bg-emerald-50 text-emerald-800 border border-emerald-200">
                  ...
                  <div className="p-1.5 space-y-1">
                    <button
                      ...
                      className="w-full text-left px-3.5 py-2.5 text-xs font-bold text-slate-800 hover:text-slate-950 hover:bg-slate-50 rounded-xl flex items-center gap-2.5 transition-colors cursor-pointer"
                    >
                    ...
                    {(currentUser.role === 'admin' || currentUser.role === 'super_admin') && (
                      <button
                        ...
                        className="w-full text-left px-3.5 py-2.5 text-xs font-bold text-amber-900 bg-amber-50 hover:bg-amber-100 rounded-xl flex items-center gap-2.5 transition-colors cursor-pointer border border-amber-200/60"
                      >
                    ...
                    <div className="pt-1 border-t border-slate-100">
                      <button
                        ...
                        className="w-full text-left px-3.5 py-2.5 text-xs font-bold text-rose-600 hover:bg-rose-50 rounded-xl flex items-center gap-2.5 transition-colors cursor-pointer"
                      >
                        <LogOut className="w-4 h-4 text-rose-500" />
                        <span>Sign Out of Monvera</span>
                      </button>
                    </div>
                  </div>
                </div>
